...
class AlpacaMCP(BaseMCPServer):
    ...
    def _initialize_client(self) -> Tuple[TradingClient, StockHistoricalDataClient]:
        ...
        try:
            ...
            api_secret = self.config.get("api_secret") or os.environ.get("ALPACA_API_SECRET")
    ...
    def _initialize_endpoints(self) -> Dict[str, Dict[str, Any]]:
        ...
        return {
            ...
            "get_portfolio_history": {
                ...
                "category": "account",
                "required_params": [],
                "optional_params": ["period", "timeframe", "date_start", "date_end", "extended_hours"],
            ...
            "get_orders": {
                ...
                "category": "orders",
                "required_params": [],
                "optional_params": ["status", "limit", "after", "until", "direction", "nested"],
            ...
            "submit_market_order": {
                ...
                "optional_params": ["time_in_force", "extended_hours", "client_order_id"],
