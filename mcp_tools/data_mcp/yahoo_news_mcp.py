...
class YahooNewsMCP(BaseDataMCP):
    ...
    def _initialize_client(self) -> Dict[str, Any]:
        ...
        try:
            ...
            config = {
                "default_news_limit": self.default_news_limit
            }
    ...
    def _initialize_endpoints(self) -> Dict[str, Dict[str, Any]]:
        ...
        return {
            "ticker_news": {
                ...
                "default_values": {
                    "limit": str(self.default_news_limit)
                },
    ...
    def _handle_ticker_news(self, params: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            # Clean up the news items to ensure all values are JSON serializable
            clean_news = []
            for item in news:
                clean_item = {}
                for k, v in item.items():
                    if isinstance(v, (str, int, float, bool, type(None))):
                        ...
                        clean_item[k] = v
                        clean_item["datetime_iso"] = datetime.fromtimestamp(v).isoformat()
                    else:
                        clean_item[k] = str(v)
    ...
    def _handle_news_search(self, params: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            market_news = self._handle_market_news({"limit": limit * 2})  # Get more to filter
    ...
    def _handle_news_sentiment(self, params: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            if sentiment_results:
                avg_score = sum(item["sentiment_score"] for item in sentiment_results) / len(sentiment_results)
